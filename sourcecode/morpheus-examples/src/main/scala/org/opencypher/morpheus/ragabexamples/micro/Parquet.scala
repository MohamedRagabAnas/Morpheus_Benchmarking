...
object Parquet extends App {
  ...
  val parquetPgds = GraphSources.fs("hdfs://172.17.77.48:9000/user/hadoop/morpheus/LDBC3").parquet
  ...
  //val ds=args(0)
  val ds="ldbc3"
  val fos = new FileOutputStream(new File(s"/home/hadoop/MorpheusBench/Expriments/Logs/$ds/Parquet/$ds.txt"),true)
