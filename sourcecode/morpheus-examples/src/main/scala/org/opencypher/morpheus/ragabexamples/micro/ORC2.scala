...
object ORC2 {
  ...
  val orcPgds = GraphSources.fs(s"hdfs://172.17.77.48:9000/user/hadoop/morpheus/$ds").orc
  morpheus.registerSource(Namespace("myNewGraphNameSapce"), orcPgds)
  val graph= morpheus.catalog.graph("myNewGraphNameSapce.ORC")


  val fos = new FileOutputStream(new File(s"/home/hadoop/MorpheusBench/Expriments/Logs/micro/ORC/$ds.txt"),true)
