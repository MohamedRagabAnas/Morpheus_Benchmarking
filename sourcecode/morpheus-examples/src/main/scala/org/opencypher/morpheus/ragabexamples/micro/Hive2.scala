...
object Hive2 {
  ...
  val hive_database = args(0).toLowerCase()  //Hive_Dtabase  "ldbc1"
  ...
  val fos = new FileOutputStream(new File(s"/home/hadoop/MorpheusBench/Expriments/Logs/micro/Hive/$hive_database.txt"),true)
