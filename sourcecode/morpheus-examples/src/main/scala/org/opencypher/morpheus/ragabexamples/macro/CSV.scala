...
object CSV extends App {
  ...
  println("Morpheus session created here")
  ...
  /*Notes:
  Q7, Q17, Q22 Running but they take very long time (more than 3h in average with LDBC3!!)
  Q10, Q11, Q13, Q16, Q25 Are not applicaple in the context of Morpheus.
  */
